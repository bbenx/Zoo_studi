...
class AnimauxFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $faker = Factory::create('fr_FR');
            ...
            $animaux7->setHabitat($this->getReference("habitat_3"));
            ...
            $animaux8->setHabitat($this->getReference("habitat_3"));
            ...
            $animaux9->setHabitat($this->getReference("habitat_3"));
            ...
            $animaux10->setHabitat($this->getReference("habitat_4"));
            ...
            $animaux11->setHabitat($this->getReference("habitat_4"));
            ...
            $animaux12->setHabitat($this->getReference("habitat_4"));
            ...
            $animaux13->setHabitat($this->getReference("habitat_4"));
            ...
            $animaux14->setHabitat($this->getReference("habitat_5"));
            ...
            $animaux15->setHabitat($this->getReference("habitat_5"));
            ...
            $animaux16->setHabitat($this->getReference("habitat_6"));
            ...
            $animaux17->setHabitat($this->getReference("habitat_6"));
            ...
            $animaux18->setHabitat($this->getReference("habitat_6"));
            ...
            $animaux19->setHabitat($this->getReference("habitat_7"));
            ...
            $animaux20->setHabitat($this->getReference("habitat_7"));
            ...
            $animaux21->setHabitat($this->getReference("habitat_7"));
            ...
            $animaux22->setHabitat($this->getReference("habitat_8"));
            ...
            $animaux23->setHabitat($this->getReference("habitat_8"));
            ...
            $animaux24->setHabitat($this->getReference("habitat_8"));
